...
export const transactionEntryType = ['DEBIT','CREDIT'] as const
export const payLaterStatus = ["DUE", "PAID"] as const
export const loanStatus =["ONGOING", "PAID"] as const
export const loanDirection =["TAKEN", "GIVEN"] as const
